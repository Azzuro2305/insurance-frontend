        ...
        <div className=" mid:bg-[#214C9B]  text-white xs2:p-2 mid:p-3  mid:rounded-lg mid:shadow-lg border-b border-[#214C9B]">
          ...
          <nav className="flex items-center xs2:justify-between mid:space-x-8">
            <div className={`xs2:bg-[#214C9B] xs2:hidden mid:block mid:flex flex-wrap text-[13px] font-semibold mid:gap-y-4 gap-x-2`}>
              <Link to='/' className="text-[12px] selection:cursor-pointer">
                HOME
              </Link>
              <div className="flex gap-2 items-baseline">
                <Link className="text-[12px]">ABOUT US</Link>
                <img className="w-2 h-2" src={Images.dropdown} alt="" />
              </div>
              <div className="flex gap-2 items-baseline">
                <Link className="text-[12px]">INSURANCE PRODUCTS</Link>
                <img className="w-2 h-2" src={Images.dropdown} alt="" />
              </div>
              <div className="flex gap-2 items-baseline">
                <Link className="text-[12px]">CUSTOMER HUB</Link>
                <img className="w-2 h-2" src={Images.dropdown} alt="" />
              </div>
              <div className="flex gap-2 items-baseline">
                <Link className="text-[12px]">NEWS & MEDIA</Link>
                <img className="w-2 h-2" src={Images.dropdown} alt="" />
              </div>
              <Link className="text-[12px]">CONTACT US</Link>
            </div>
            ...
            <div className="flex mid:flex-row-reverse flex-wrap xs2:float-left gap-x-2 text-[13px] font-semibold text-[#214C9B] xs2:items-start gap-y-1">
              <Link className="xs2:bg-[#214C9B] text-[12px] mid:bg-white  p-2 rounded-md xs2:text-white mid:text-[#214C9B]">
                Premium Calculator
              </Link>
              <Link className="xs2:bg-[#214C9B] text-[12px] mid:bg-white  p-2 rounded-md xs2:text-white mid:text-[#214C9B]">
                Print Certificates
              </Link>
              <Link className="xs2:bg-[#214C9B] text-[12px] mid:bg-white  p-2 rounded-md xs2:text-white mid:text-[#214C9B]">Online Biller</Link>
              <Link className="xs2:bg-[#214C9B] text-[12px] mid:bg-white  p-2 rounded-md xs2:text-white mid:text-[#214C9B]">Buy Online</Link>
            </div>
