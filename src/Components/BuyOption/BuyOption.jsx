...
export const BuyOption = () => {
    ...
    return (
        <div className='my-8'>
            ...
            <Link to="/" className='bg-[#214C9B] text-white mt-1 px-6 py-2 rounded-[3px] hover:bg-white hover:border-[#214C9B] border hover:text-[#214C9B] transition-all duration-300'>
